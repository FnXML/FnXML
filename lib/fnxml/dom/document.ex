defmodule FnXML.DOM.Document do
  ...
  ## Examples
      ...
      %FnXML.DOM.Document{
        root: %FnXML.DOM.Element{tag: "html", children: [...]},
  ...
  ## Examples
      ...
      iex> root = FnXML.DOM.Element.new("html")
      iex> doc = FnXML.DOM.Document.new(root)
      iex> doc.root.tag
      "html"
  """
  ...
  ## Examples
      ...
      iex> root = FnXML.DOM.Element.new("root")
      iex> doc = FnXML.DOM.Document.new(root, version: "1.0", encoding: "UTF-8")
      iex> doc.prolog
