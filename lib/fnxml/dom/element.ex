defmodule FnXML.DOM.Element do
  ...
  ## Examples
      ...
      %FnXML.DOM.Element{
        ...
        attributes: [{"id", "123"}],
        children: [
          %FnXML.DOM.Element{tag: "title", children: ["XML Guide"]},
          %FnXML.DOM.Element{tag: "author", children: ["Jane Doe"]}
        ],
  ...
  Children can be:
  - `%FnXML.DOM.Element{}` - Child element
  ...
  ## Examples
      ...
      iex> FnXML.DOM.Element.new("div")
      %FnXML.DOM.Element{tag: "div", attributes: [], children: []}

      iex> FnXML.DOM.Element.new("div", [{"class", "container"}])
      %FnXML.DOM.Element{tag: "div", attributes: [{"class", "container"}], children: []}

      iex> FnXML.DOM.Element.new("p", [], ["Hello"])
      %FnXML.DOM.Element{tag: "p", attributes: [], children: ["Hello"]}
  """
  ...
  ## Examples
      ...
      iex> FnXML.DOM.Element.new_ns("http://www.w3.org/1999/xhtml", "div", "html")
      %FnXML.DOM.Element{
        tag: "div",
  ...
  ## Examples
      ...
      iex> elem = FnXML.DOM.Element.new("div", [{"id", "main"}, {"class", "container"}])
      iex> FnXML.DOM.Element.get_attribute(elem, "id")
      "main"
      iex> FnXML.DOM.Element.get_attribute(elem, "style")
      nil
  """
  ...
  ## Examples
      ...
      iex> elem = FnXML.DOM.Element.new("div")
      iex> elem = FnXML.DOM.Element.set_attribute(elem, "id", "main")
      iex> FnXML.DOM.Element.get_attribute(elem, "id")
      "main"
  """
  ...
  ## Examples
      ...
      iex> elem = FnXML.DOM.Element.new("div", [{"id", "main"}])
      iex> elem = FnXML.DOM.Element.remove_attribute(elem, "id")
      iex> FnXML.DOM.Element.get_attribute(elem, "id")
      nil
  """
  ...
  ## Examples
      ...
      iex> elem = FnXML.DOM.Element.new("div", [{"id", "main"}])
      iex> FnXML.DOM.Element.has_attribute?(elem, "id")
      true
      iex> FnXML.DOM.Element.has_attribute?(elem, "class")
      false
  """
  ...
  ## Examples
      ...
      iex> parent = FnXML.DOM.Element.new("div")
      iex> child = FnXML.DOM.Element.new("span")
      iex> parent = FnXML.DOM.Element.append_child(parent, child)
  ...
  ## Examples
      ...
      iex> elem = FnXML.DOM.Element.new("p", [], ["Hello ", %FnXML.DOM.Element{tag: "b", children: ["world"]}])
      iex> FnXML.DOM.Element.text_content(elem)
      "Hello world"
  """
  ...
  ## Examples
      ...
      iex> parent = %FnXML.DOM.Element{
      ...>   tag: "ul",
      ...>   children: [
      ...>     %FnXML.DOM.Element{tag: "li", children: ["One"]},
      ...>     %FnXML.DOM.Element{tag: "li", children: ["Two"]}
      ...>   ]
      ...> }
      iex> FnXML.DOM.Element.get_elements_by_tag_name(parent, "li") |> length()
      2
  """
