defmodule FnXML.DOM.Serializer do
  ...
  ## Examples
      ...
      FnXML.DOM.Serializer.to_string(doc)
      # => "<root><child/></root>"

      FnXML.DOM.Serializer.to_string(doc, pretty: true)
      # => "<root>\\n  <child/>\\n</root>"
  """
  ...
  ## Examples
      ...
      iex> elem = FnXML.DOM.Element.new("root", [], ["text"])
      iex> FnXML.DOM.Serializer.to_string(elem)
      "<root>text</root>"
  """
  ...
  ## Examples
      ...
      iex> elem = FnXML.DOM.Element.new("root", [], ["text"])
      iex> FnXML.DOM.Serializer.to_stream(elem) |> Enum.to_list()
