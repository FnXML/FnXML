defmodule FnXML.Security.C14N do
  @moduledoc """
  ...
  ## Usage
      ...
      canonical = FnXML.Parser.parse(xml) |> FnXML.Security.C14N.canonicalize()
      # => "<root a=\"1\" b=\"2\"><child></child></root>"

      # Exclusive C14N with inclusive namespaces
      FnXML.Parser.parse(xml)
      |> FnXML.Security.C14N.canonicalize(
        algorithm: :exc_c14n,
  ...
  alias FnXML.Security.C14N.Serializer
  ...
  ## Examples
      ...
      iex> FnXML.Parser.parse("<root/>") |> FnXML.Security.C14N.canonicalize()
      "<root></root>"

      iex> FnXML.Parser.parse("<root b='2' a='1'/>") |> FnXML.Security.C14N.canonicalize()
      "<root a=\"1\" b=\"2\"></root>"
  ...
  ## Examples
      ...
      iex> FnXML.Security.C14N.algorithm_uri(:c14n)
      "http://www.w3.org/TR/2001/REC-xml-c14n-20010315"

      iex> FnXML.Security.C14N.algorithm_uri(:exc_c14n)
  ...
  ## Examples
      ...
      iex> FnXML.Security.C14N.algorithm_atom("http://www.w3.org/TR/2001/REC-xml-c14n-20010315")
      {:ok, :c14n}

      iex> FnXML.Security.C14N.algorithm_atom("unknown")
