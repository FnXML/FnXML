defmodule FnXML.Utf16 do
  ...
  ## Usage
      ...
      # With binaries
      xml = File.read!("document.xml") |> FnXML.Utf16.to_utf8()
  ...
  ## Examples
      ...
      # Binary input
      xml = File.read!("file.xml") |> FnXML.Utf16.to_utf8()
      FnXML.Parser.parse(xml)
  ...
  ## Examples
      ...
      |> FnXML.Utf16.to_utf8(encoding: :utf16_le)
      |> FnXML.ParserStream.parse()
  ...
  ## Examples
      ...
      iex> FnXML.Utf16.detect_encoding(<<0xFF, 0xFE, 0x3C, 0x00>>)
      {:utf16_le, <<0x3C, 0x00>>}

      iex> FnXML.Utf16.detect_encoding(<<0xFE, 0xFF, 0x00, 0x3C>>)
      {:utf16_be, <<0x00, 0x3C>>}

      iex> FnXML.Utf16.detect_encoding("<root/>")
      {:utf8, "<root/>"}
