defmodule FnXML.Normalize do
  ...
  ## Examples
      ...
      iex> FnXML.Normalize.line_endings("a\\r\\nb")
      "a\\nb"

      iex> FnXML.Normalize.line_endings("a\\rb")
      "a\\nb"
  ...
  ## Usage
      ...
      xml = File.read!("input.xml") |> FnXML.Normalize.line_endings()
