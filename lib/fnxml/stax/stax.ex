defmodule FnXML.StAX do
  ...
  ### Cursor API (`FnXML.StAX.Reader` / `FnXML.StAX.Writer`)
  ...
  ## Examples
      ...
      writer = FnXML.StAX.create_writer()
  """
  @spec create_writer(keyword()) :: FnXML.StAX.Writer.t()
  defdelegate create_writer(opts \\ []), to: FnXML.StAX.Writer, as: :new
